...
export function HomeView({ initialTasks, initialError }: HomeViewProps) {
  const { tasks, counts, filter, setFilter, sort, setSort, loading, error, refresh } =
    useTasks({ initialTasks, initialError });
